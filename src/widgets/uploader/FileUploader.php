...
class FileUploader extends FileUploadUI
{
     ...
     *
     * @var \gearsoftware\db\ActiveRecord
     */
    public $model;
     ...
     * @var string
     */
    public $formView = '@vendor/gearsoftware/yii2-media/widgets/uploader/views/form';
     ...
     * @var string
     */
    public $uploadTemplateView = '@vendor/gearsoftware/yii2-media/widgets/uploader/views/upload';
     ...
     * @var string
     */
    public $downloadTemplateView = '@vendor/gearsoftware/yii2-media/widgets/uploader/views/download';
